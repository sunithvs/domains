...
ALLOWED_HOSTS = ["*"]
cors_allowed_origins = ["https://localhost:8000", "https://domains.sunithvs.com", "https://trebuchet.one"]
# Application definition
CSRF_TRUSTED_ORIGINS = ["https://localhost:8000", "https://domains.sunithvs.com", "https://trebuchet.one"]
INSTALLED_APPS = [
    # third party apps
    "jazzmin",
    "rest_framework",
